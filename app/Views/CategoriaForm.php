...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-5 flex flex-col gap-5 max-w-[500px] mx-auto my-10" method='post' action='<?=base_url('/insertar_categoria')?>'>
      <div>
        <h1 class="text-center text-[2rem] font-bold pb-[3px] mb-0">Registrar Categoria</h1>
