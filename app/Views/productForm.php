...
<html class="scroll-smooth">
  ...
  <?php helper('form');?> <!-- LLamamos a la funcion helper para poder utilizarlo mas tarde -->
    ...
    <form class="text-black p-5 flex flex-col gap-5 max-w-[500px] mx-auto my-10" method='POST' enctype="multipart/form-data" action='<?= base_url('/insertar_producto') ?>'>
    <div>
    ...
    <div>
        <button class="block text-white bg-black p-2 rounded-[4px] w-full" type="submit">Registrar</button>
    </div>
</form>
