  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <div class="container mx-auto p-4">
        <table class="table-auto w-full bg-white shadow-lg rounded-lg">
            <thead class="bg-rose-400 text-slate-50">
                <tr>
                    <th class="px-4 py-2">ID</th>
                    <th class="px-4 py-2">SupplierName</th>
                    <th class="px-4 py-2">ContactName</th>
            ...
            <tbody>
                <?php foreach ($proveedor['proveedor']->getResultArray() as $fila) { ?>
                <tr>
                    <td class="border px-4 py-2"><?=$fila['SupplierID']?></td>
                    <td class="border px-4 py-2"><?=$fila['SupplierName']?></td>
                    <td class="border px-4 py-2"><?=$fila['ContactName']?></td>
                    <td class="border px-4 py-2"><?=$fila['PostalCode']?></td>
                    <td class="border px-4 py-2"><?=$fila['Phone']?></td>
                    <td class="border px-4 py-2">
                        <a href="<?=base_url('/editar_proveedor?id='.$fila['SupplierID'])?>" class="text-pink-600 font-semibold hover:text-pink-800">EDITAR</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
