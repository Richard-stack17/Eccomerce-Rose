...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-10 flex flex-col gap-7  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-white via-white to-rose-100">
      <h1 class="text-center text-[3rem] text-red-600 font-bold mb-4">¿Qué operación deseas realizar?</h1>
      <div class="flex flex-wrap justify-center items-center gap-5">
        
            <a class="bg-white border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/registrar_Categoria')?>">
                <div class="text-center bg-rose-100 text-[1.5rem] font-black rounded-t-2xl border-rose-500 border-b-[4px] text-red-700 tracking-widest styleShadow"><h2>Registrar</h2></div>
                <div class="p-5"><img src="../src/img/register.png"/></div>
            </a>
            <a class="bg-red-50 border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/mostrar_categoria')?>">
                <div class="text-center bg-rose-100 text-[1.5rem] font-black rounded-t-2xl border-rose-500 border-b-[4px] text-red-700 tracking-widest styleShadow">Editar y visualizar</div>
                <div class="p-5"><img src="../src/img/update.png" class="w-full object-cover"/></div>
            </a>
        
            <a class="bg-white border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/view_categoria')?>">
                <div class="text-center bg-rose-100 text-[1.5rem] font-black rounded-t-2xl border-rose-500 border-b-[4px] text-red-700 tracking-widest styleShadow">Borrar</div>
                <div class="p-5"><img src="../src/img/delete.png" class="w-full object-cover"/></div>
            </a>
