...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-5 flex flex-col gap-5 max-w-[500px] mx-auto my-10" method='post' action="<?=base_url('/guardar_empleado')?>">
        <div>
            <h1 class="text-center text-[2rem] font-bold pb-[3px] mb-0">Editar Empleado</h1>
            <div class="h-[2px] bg-black p-0 m-0 w-[80px] mx-auto my-0"></div>
          </div>
      <div>
        <input type="hidden"  name='id' value='<?php
                echo $empleado['empleado']['EmployeeID'];
                ?>'>
        ...
        <input
          ...
          name='nombre'
          value='<?php
                echo $empleado['empleado']['FirstName'];
                ?>'>
      </div>
      <div>
        <label class="block font-extrabold mb-1">Apellido</label>
        <input
          type="text"
          class="block border-[2px] border-gray-400 w-full p-2"
          name='apellido'
          value='<?php
                echo $empleado['empleado']['LastName'];
                ?>'
        />
      </div>
      <div>
        <label class="block font-extrabold mb-1">Fecha de Cumpleaños</label>
        <input
          type="date" 
          id='cumpleaños' 
          name='cumpleaños'
          class="block border-[2px] border-gray-400 w-full p-2"
          value='<?php
                echo $empleado['empleado']['BirthDate'];
                ?>'
        />
      </div>
      <div>
