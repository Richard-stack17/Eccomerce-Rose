  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <div class="container mx-auto p-4">
        <table class="table-auto w-full bg-white shadow-lg rounded-lg">
            ...
            <tbody>
                <?php foreach ($empleado['empleado']->getResultArray() as $fila) { ?>
                <tr>
                    <td class="border px-4 py-2"><?=$fila['EmployeeID']?></td>
                    <td class="border px-4 py-2"><?=$fila['LastName']?></td>
                    <td class="border px-4 py-2"><?=$fila['FirstName']?></td>
                    <td class="border px-4 py-2"><?=$fila['BirthDate']?></td>
                    <td class="border px-4 py-2"><?=$fila['Notes']?></td>
                    <td class="border px-4 py-2"><?=$fila['DNI']?></td>
                    <td class="border px-4 py-2">
                        <a href="<?=base_url('/editar_empleado?id='.$fila['EmployeeID'])?>" class="text-pink-600 font-semibold hover:text-pink-800">EDITAR</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
