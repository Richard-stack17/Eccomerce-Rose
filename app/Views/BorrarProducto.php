            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <img src="<?= $rutaImagen ?>" alt="Imagen del producto" width="50" height="50">
                    </td>
                    <td class="border px-4 py-2">
                        <a href="<?=base_url('/borrar_producto?id='.$fila['ProductID'])?>" class="text-pink-600 font-semibold hover:text-pink-800">BORRAR</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
