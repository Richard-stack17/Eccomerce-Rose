...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-5 flex flex-col gap-5 max-w-[500px] mx-auto my-10" method='post' action='<?=base_url('/insertar_proveedor')?>'>
        <div>
      ...
      <div>
        <button class="block text-white bg-black p-2 rounded-[4px] w-full"><input type="submit" value='Registrar'></button>
      </div>
    </form>
    </div>
