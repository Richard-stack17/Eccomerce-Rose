        ...
        <table class="table-auto w-full bg-white shadow-lg rounded-lg">
            <thead class="bg-rose-400 text-slate-50">
                <tr>
                    ...
                    <th class="px-4 py-2">ShipperName</th>
                    <th class="px-4 py-2">Phone</th>
                    <th class="px-4 py-2">Acciones</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($Expedidor['Expedidor']->getResultArray() as $fila) { ?>
                <tr>
                    <td class="border px-4 py-2"><?=$fila['ShipperID']?></td>
                    <td class="border px-4 py-2"><?=$fila['ShipperName']?></td>
                    <td class="border px-4 py-2"><?=$fila['Phone']?></td>
                    <td class="border px-4 py-2">
                        <a href="<?=base_url('/editar_expedidor?id='.$fila['ShipperID'])?>" class="text-pink-600 font-semibold hover:text-pink-800">EDITAR</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
