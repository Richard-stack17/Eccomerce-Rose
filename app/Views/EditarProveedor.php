...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-5 flex flex-col gap-5 max-w-[500px] mx-auto my-10" method='post' action='<?=base_url('/guardar_proveedor')?>'>
        <div>
            <h1 class="text-center text-[2rem] font-bold pb-[3px] mb-0">Registrar Proveedor</h1>
            <div class="h-[2px] bg-black p-0 m-0 w-[80px] mx-auto my-0"></div>
          </div>
      <div>
      <input type="hidden" name='id' value='<?php
                echo $proveedor['supplier']['SupplierID'];
                ?>'
        <label class="block font-extrabold mb-1">Nombre de la empresa</label>
        <input
          type="text"
          class="block border-[2px] border-gray-400 w-full p-2"
          name='empresa'
          value='<?php
                echo $proveedor['supplier']['SupplierName'];
                ?>'
        />
      </div>
      <div>
        <label class="block font-extrabold mb-1">Nombre del contacto</label>
        <input
          type="text"
          class="block border-[2px] border-gray-400 w-full p-2"
          name='contacto'
          value='<?php
                echo $proveedor['supplier']['ContactName'];
                ?>'
        />
      </div>
      <div>
        ...
        <input
          ...
          name='direccion'
          value='<?php
                echo $proveedor['supplier']['Address'];
                ?>'
        />
      </div>
      <div>
        ...
        <input
          ...
          name='ciudad'
          value='<?php
                echo $proveedor['supplier']['City'];
                ?>'
        />
      </div>
      <div>
        <label class="block font-extrabold mb-1">Código postal</label>
        <input
          type="number"
          class="block border-[2px] border-gray-400 w-full p-2"
          name='codigoP'
          value='<?php
                echo $proveedor['supplier']['PostalCode'];
                ?>'
        />
      </div>
      <div>
        ...
        <input
          ...
          name='pais'
          value='<?php
                echo $proveedor['supplier']['Country'];
                ?>'
        />
      </div>
      <div>
        ...
        <input
          ...
          name='telefono'
          value='<?php
                echo $proveedor['supplier']['Phone'];
                ?>'
        />
      </div>
      
      <div>
        <button class="block text-white bg-black p-2 rounded-[4px] w-full"><input type="submit" value='GUARDAR'></button>
      </div>
    </form>
    </div>
