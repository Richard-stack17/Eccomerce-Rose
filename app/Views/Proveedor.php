  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <form class="text-black p-10 flex flex-col gap-7  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-white via-white to-rose-100">
      ...
      <div class="flex flex-wrap justify-center items-center gap-5">
            ...
            <a class="bg-white border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/registrar_proveedor')?>">
            ...
            <a class="bg-red-50 border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/mostrar_proveedor')?>">
            ...
            <a class="bg-white border-[5px] border-rose-500 max-w-[300px] rounded-2xl cursor-pointer" href="<?=base_url('/view_proveedor')?>">
