...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    >
    <form class="p-4 flex flex-col gap-5 max-w-[500px] mx-auto my-10 text-rose-900" method="POST" action='<?= base_url('/generar_ordenDetail?id='.$product['ProductID'].'&cantidad='.$cantidad.'&customerId='.$customerId.'&orderId='.$ordenId)?>'>
        <div>
            <h1 class="text-center text-[2rem] font-bold pb-[3px] mb-0">Por el momento solo contamos con pago en efectivo</h1>
            <div class="h-[2px] bg-black p-0 m-0 lg:w-[600px] mx-auto my-0 max-w-[500px]"></div>
          </div>
      <div class="flex justify-between">
        <label class="block font-extrabold mb-1">¿Desea realizar el pago?</label>
