        ...
        <table class="table-auto w-full bg-white shadow-lg rounded-lg">
            <thead class="bg-rose-500 text-white">
                <tr>
                    ...
                    <th class="px-4 py-2">Expedidor</th>
                    <th class="px-4 py-2">Producto</th>
                    <th class="px-4 py-2">Categoria</th>
                    <th class="px-4 py-2">Cantidad</th>
                    <th class="px-4 py-2">CostoTotal</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($consulta['consulta']->getResultArray() as $fila) { ?>
                <tr>
                    <td class="border px-4 py-2"><?=$fila['OrderDetailID']?></td>
                    <td class="border px-4 py-2"><?=$fila['CustomerName']?></td>
                    <td class="border px-4 py-2"><?=$fila['LastName']?></td>
                    <td class="border px-4 py-2"><?=$fila['ShipperName']?></td>
                    <td class="border px-4 py-2"><?=$fila['ProductName']?></td>
                    <td class="border px-4 py-2"><?=$fila['CategoryName']?></td>
                    <td class="border px-4 py-2"><?=$fila['Quantity']?></td>
                    <td class="border px-4 py-2"><?=$fila['TotalCost']?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
