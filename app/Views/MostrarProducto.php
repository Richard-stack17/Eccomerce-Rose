  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <div class="container mx-auto p-4">
        <table class="table-auto w-full bg-white shadow-lg rounded-lg">
            <thead style="text-shadow:1px 1.5px black" class="bg-rose-400 text-slate-50">
                <tr>
            ...
            <tbody>
                <?php foreach ($producto['producto']->getResultArray() as $fila) { ?>
                <tr>
                    <td class="border px-4 py-2"><?=$fila['ProductID']?></td>
                    <td class="border px-4 py-2"><?=$fila['ProductName']?></td>
                    <td class="border px-4 py-2"><?=$fila['CategoryName']?></td>
                    <td class="border px-4 py-2">
                        <?php $rutaImagen = '../src/Imagenes/' . $fila['Image']; ?>
                        <img src="<?= $rutaImagen ?>" alt="Imagen del producto" class="w-12 h-12">
                    </td>
                    <td class="border px-4 py-2">
                        <a href="<?=base_url('/editar?id='.$fila['ProductID'])?>" class="text-pink-600 font-semibold hover:text-pink-800">EDITAR</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
