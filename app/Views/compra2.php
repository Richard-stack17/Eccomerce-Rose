...
<html class="scroll-smooth">
  ...
  <body style="font-family: 'Barlow', sans-serif">
    ...
    <h1 class="text-[2rem] font-bold text-center text-red-800">Ya casi finalizamos la compra :)</h1>
    <section
      class="p-3 flex flex-wrap gap-5 bg-rose-200 text-[1.2rem] min-[500px]:items-center min-[500px]:justify-center"
    >
    <form class="text-rose-900 p-4 flex flex-col gap-5 max-w-[900px] mx-auto my-10" method="post" action='<?= base_url('/insertar_cliente?id='.$product['ProductID'].'&cantidad='.$cantidad)?>'>
        <div>
            <h1 class="text-center text-[2rem] font-bold pb-[3px] mb-0">Email y Datos</h1>
            <div class="h-[2px] bg-rose-900 p-0 m-0 lg:w-[600px] mx-auto my-0 max-w-[500px]"></div>
          </div>
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Nombres:</label>
        <input
          name="nombres"
          type="text"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
        />
      </div>
      <div class="flex  flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Apellidos:</label>
        <input
          name="apellidos"
          type="text"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Dirección:</label>
        <input
          name="direccion"
          type="text"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Ciudad:</label>
        <input
          name="ciudad"
          type="text"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Email:</label>
        <input
          name="email"
          type="email"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">País:</label>
        <input
            name="pais"
          type="text"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <div class="flex flex-col min-[500px]:flex-row gap-5 justify-between">
        <label class="block font-extrabold mb-1">Telefono del contacto:</label>
        <input
          name="telefono"
          type="number"
          class="block border-[2px] border-gray-400 p-2 h-[30px] max-w-[400px]"
      ...
      <a>
        <button class="block my-5 text-white bg-rose-800 p-4 w-full">
          Confirmar compra y envío a pago efectivo
        </button>
      </a>
    </form>
      <div
        class="flex flex-col justify-center items-center gap-4 max-w-[350px] mx-auto my-0 p-5 text-[white]  rounded-lg  bg-gradient-to-r from-rose-400 to-red-400 border-black border-[4px] w-full p-0 m-0"
      >
        <h2 style="text-shadow:1.5px 1px black" class="font-bold">Resumen de la compra</h2>
        <div class="flex flex-wrap gap-5">
          
          <p>Precio:</p>
          <p class="font-bold text-white">S/. <?=$product['Price']?></p>
          <p>Cantidad:</p>
          <p class="font-bold text-white"><?=$cantidad?></p>
          <p>Total:</p>
          <p class="font-bold text-white"><?='S/. '.$cantidad*$product['Price']?></p>
        </div>
